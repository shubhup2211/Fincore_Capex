...
{
    /// <inheritdoc />
    public partial class newcapex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CapexRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CapexReqNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CapexRequests_ApprovalFlows_RequiredRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    ModifiedBy = table.Column<int>(type: "int", nullable: false),
                    ApprovalFlowId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RFQs_Employees_ModifiedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetLines_VendorCategoryId",
                table: "BudgetLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CapexRequests_RequiredRoleId",
                table: "CapexRequests",
                column: "RequiredRoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequisitions_CategoryId",
                table: "PurchaseRequisitions",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequisitions_RequiredRoleId",
                table: "PurchaseRequisitions",
                column: "RequiredRoleId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_BudgetLines_VendorCategories_VendorCategoryId",
                table: "BudgetLines",
                column: "VendorCategoryId",
                principalTable: "VendorCategories",
                principalColumn: "VendorCategoryId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PurchaseRequisitions_Roles_RequiredRoleId",
                table: "PurchaseRequisitions",
                column: "RequiredRoleId",
                principalTable: "Roles",
                principalColumn: "RoleId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PurchaseRequisitions_VendorCategories_CategoryId",
                table: "PurchaseRequisitions",
                column: "CategoryId",
                principalTable: "VendorCategories",
                principalColumn: "VendorCategoryId",
